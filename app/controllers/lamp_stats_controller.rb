class LampStatsController < ApplicationController
  ...
  private
    ...
    def lamp_stat_params
      params.require(:lamp_stat).permit(:serialNum, :date, :pwr, :current, :volts, :tCom, :tLed1, :tLed2, :sLum, :rssiDev, :lqiDev, :rssi, :lqi, :correlationDev, :correlation, :sentPkts, :rcvPkts, :lastReboot, :txPwr, :ctrlRestart, :vFirmware, :vCmd, :cksCfg, :appCksErr, :cmdNotImp, :online, :communicating, :sunrise, :sunset)
    end
end
