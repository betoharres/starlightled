...
RSpec.describe "gateway_stats/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit gateway_stat form" do
    render

    assert_select "form[action=?][method=?]", gateway_stat_path(@gateway_stat), "post" do
