...
RSpec.describe TasksController, type: :controller do
  ...
  before :all do
    @authorized_user = auth_user(ability: :can_all, resource: 'Task')
    @unauthorized_user = auth_user(ability: :can_none, resource: 'Task')
  ...
  let(:valid_attributes) {
    {execute_at: DateTime.now,
     code: 100,
     node_id: @node.id,
     attachable_id: @firmware.id,
     attachable_type: 'Firmware',
     company: @authorized_user.company
    }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested task" do
        ...
        task.reload
        expect(task.aasm_state).to eql new_attributes[:aasm_state]
      end
