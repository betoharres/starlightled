...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:invalid_attributes) {
    {name: 10, model: 10, serial_number: 10, mac_address: 10, product_code: 10, fabrication_date: "string", tension_operation: nil}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: "Product1", model: "ModelLamp", serial_number: "ABI-200-XSA", mac_address: "000-XXX-XDA", product_code: "FFF", fabrication_date: Date.today, tension_operation: 50}
      }
      ...
      it "updates the requested product" do
        ...
        product.reload
        expect(product.model).to eq("ModelLamp")
      end
